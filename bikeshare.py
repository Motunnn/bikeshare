...
if date_filter == 'month' or date_filter == 'both':
    ...
    while month not in months:
        ...
        print(f"\nCool!! You have chosen {month.title()} as the month of interest.")

      
# TO DO: get user input for day of week (all, monday, tuesday, ... sunday)  
days = ['mon', 'tue', 'wed', 'thurs', 'fri', 'sat', 'sun', 'all']
if date_filter == 'day' or date_filter == 'both':
    day = input('Type in which day you want to see - mon, tue, wed, thurs, fri, sat, sun or all? ').lower()
    while day not in days:
        print('"\nSorry, you can only filter by the following days: mon, tue, wed, thurs, fri, sat, sun or all')
        day = input('Retry entering a day in the format above --> ').lower()
    else:
       print(f"\nCool!! You have chosen {day.title()} as the day of interest.")
...
if date_filter == 'month': 
    ...
    print(str(month.title()) + str(day.title()))
